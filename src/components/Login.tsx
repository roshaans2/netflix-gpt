    ...
    return(
        <div>
            ...
            <form className="w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
                ...
                <input type="text" placeholder="Email" className="p-4 my-4 w-full bg-gray-900 bg-opacity-80" />
                <input type="password" placeholder="Password" className="p-4 my-4 w-full bg-gray-900 bg-opacity-80"/>
